        ...
        return (
            <div className="LoginInterestSelection container">
                <h2 ref={this.alertRef} 
                    ...
                    role='region' aria-label='Title: What are you most interested in?'>
                    What are you most interested in?
                </h2>
                {this.state.isAlertVisible &&
                    <div role='region' style={{ fontFamily: 'Montserrat', color: '#c82368' }}>You have to select at least one interest</div>
                }
